...
CPU intel = new CPU(48000);
CPU.Processor i_processor = intel.new Processor(8, "intel CORE i7");
CPU.Ram i_ram = new Ram(1024, "LENOVO");
intel.display();
i_processor.display();
i_ram.display();
...
Price of CPU : 48000
No of Cores : 8
Processor manufactures : intel CORE i7
Memory Size : 1024
Memory manufactures : LENOVO
*/
